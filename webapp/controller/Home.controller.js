sap.ui.define([
	...
	return Controller.extend("electricutilities.controller.Home", {
		...
		onEnergyButtonPress: function(oEvent)
		{
		...
		{
			this.oRouter.navTo("meterRoute");
		},

		onMeterReadingPress: function(oEvent)
		{
			this.oRouter.navTo("meterreadingRoute");
		},

		onEnergyTilePress: function(oEvent)
		{
			this.oRouter.navTo("customersRoute");
		},
